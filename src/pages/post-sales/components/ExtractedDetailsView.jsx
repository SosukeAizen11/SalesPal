...
const ExtractedDetailsView = ({ customerData, onCancel }) => {
    ...
    const [editableData, setEditableData] = useState({
        ...
        paid: (customerData.totalDue || 0) - (customerData.remaining || 0)
    });
                            ...
                            <div className="w-full md:w-1/3 flex flex-col items-center justify-center p-2 text-center border-b md:border-b-0 md:border-r border-gray-200">
                                ...
                                {isEditing ? (
                                    <div className="flex items-center text-xl font-bold text-slate-800 border-b border-indigo-300">
                                        <span>₹</span>
                                        <input type="number" value={editableData.totalDue} onChange={(e) => setEditableData({ ...editableData, totalDue: parseInt(e.target.value) || 0 })} className="w-24 text-center bg-transparent focus:outline-none" />
                                    </div>
                                ) : (
                            ...
                            <div className="w-full md:w-1/3 flex flex-col items-center justify-center p-2 text-center border-b md:border-b-0 md:border-r border-gray-200">
                                ...
                                {isEditing ? (
                                    <div className="flex items-center text-xl font-bold text-[#22c55e] border-b border-indigo-300">
                                        <span>₹</span>
                                        <input type="number" value={editableData.paid} onChange={(e) => setEditableData({ ...editableData, paid: parseInt(e.target.value) || 0 })} className="w-24 text-center bg-transparent focus:outline-none" />
                                    </div>
                                ) : (
