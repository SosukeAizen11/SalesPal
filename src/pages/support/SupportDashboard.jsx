    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Monitor support activity and customer requests.</p>
            </div>
            ...
            <div>
                <h2 className="text-sm font-medium text-gray-700 mb-4">Ticket Categories</h2>
                            ...
                            {recentTickets.map((ticket) => (
                                <tr key={ticket.id} className="hover:bg-gray-50">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm font-medium text-gray-900">{ticket.customer?.name || ticket.customer || 'Unknown Customer'}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-500">{ticket.channel || 'N/A'}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-500">{ticket.category || 'Uncategorized'}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
