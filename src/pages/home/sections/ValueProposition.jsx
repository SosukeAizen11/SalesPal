            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-96 hidden lg:flex items-center justify-center">
                    ...
                    <div className="relative w-80 h-80">
                        ...
                        {/* Orbiting icons container with rotation animation */}
                        <div className="absolute inset-0 animate-orbit">
                            {/* Bottom-left icon (TrendingUp) at ~225° */}
                            <div className="absolute" style={{
                                top: '50%',
                                left: '50%',
                                transform: 'translate(-50%, -50%) rotate(225deg) translateX(128px) rotate(-225deg)'
                            }}>
                            ...
                            {/* Bottom-right icon (Zap) at ~315° */}
                            <div className="absolute" style={{
                                top: '50%',
                                left: '50%',
                                transform: 'translate(-50%, -50%) rotate(315deg) translateX(128px) rotate(-315deg)'
                            }}>
