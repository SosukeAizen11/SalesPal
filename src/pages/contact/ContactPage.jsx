            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16 space-y-4">
                    ...
                    <p className="text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
                        Ready to automate your revenue? Book a demo or send us a message. We typically respond within a few hours.
                    </p>
                </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg shadow-slate-200/50 border border-slate-100">
                            ...
                            <div className="bg-slate-50 rounded-xl p-6 border border-slate-100 text-center">
                                <p className="text-xs font-medium text-slate-500 mb-4">
                                    Demo calendar coming soon. For now, please reach out via email or phone.
                                </p>
                                <a
                                    href="mailto:dharmendar@salespal.in?subject=Demo Request"
