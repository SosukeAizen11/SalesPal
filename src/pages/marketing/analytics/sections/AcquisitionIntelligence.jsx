...
import { ArrowUpRight, ArrowDownRight, Sparkles, Users, Target, Filter, Loader2 } from 'lucide-react';
...
const EmptyState = () => (
    <section className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-6">
        ...
        <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-700 mb-2">No Acquisition Data Yet</h3>
            <p className="text-sm text-gray-500 max-w-md mx-auto">
                Launch campaigns to start tracking leads, conversions, and channel efficiency. All analytics here are powered by real Supabase data.
            </p>
        </div>
    </section>
);
