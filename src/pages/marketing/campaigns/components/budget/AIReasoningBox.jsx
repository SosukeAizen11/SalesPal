    ...
    <div className="bg-gradient-to-br from-secondary/5 to-secondary/10 border border-secondary/20 rounded-xl p-4 flex gap-3">
        ...
        <div>
            ...
            <p className="text-xs text-gray-700 leading-relaxed">
                Based on current auction data in <strong>South Mumbai</strong> for real estate, we recommend a minimum of ₹3,500/day to achieve reliable lead volume across Meta and Google.
            </p>
        </div>
    </div>
);
