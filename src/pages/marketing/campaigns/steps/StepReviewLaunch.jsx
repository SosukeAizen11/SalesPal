                ...
                <div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center text-sm">
                            ...
                            <span className="font-semibold text-gray-900">{formatCurrency((data?.budget?.daily || data?.budget?.daily || 3500) * 30)}</span>
                        </div>

                        {/* Per-platform allocation — use new format if available */}
                        {data?.budget?.perPlatform ? (
                            ...
                            /* Legacy fallback: old meta/google bar */
                            <>
