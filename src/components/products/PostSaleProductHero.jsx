...
const PostSaleProductHero = () => {
    ...
    return (
        <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
            ...
            <div className="absolute top-40 left-1/4 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 animate-fade-in-up">
                    ...
                    >
                        <div
                            ...
                            style={{
                                ...
                                boxShadow: '0px 8px 20px rgba(168, 85, 247, 0.25)'
                            }}
                        >
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <p className="text-lg text-blue-500 font-medium mb-4 hover:underline cursor-pointer">
                            Automated Payment & Document Collection
                        </p>
                        ...
                        <p className="text-base text-gray-600 leading-relaxed mb-8 max-w-2xl">
                            The sale is just the beginning. SalesPal Post Sales ensures every customer gets a great onboarding experience, stays engaged, and becomes an advocate for your brand.
                        </p>
...
export default PostSaleProductHero;
