...
const SalesProductHero = () => {
    ...
    return (
        <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
            ...
            <div className="absolute top-40 right-1/4 w-96 h-96 bg-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 animate-fade-in-up">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <p className="text-base text-gray-600 leading-relaxed mb-8 max-w-2xl">
                            Engage every lead instantly with AI that sounds just like your best salesperson. Handle objections, answer questions, qualify prospects, and book meetings - all automatically via WhatsApp and phone calls.
                        </p>
...
export default SalesProductHero;
